...
function _construct_vertex_shader_source(){
  return VERTEX_SHADER_HEAD + VERTEX_SHADER_BODY + VERTEX_SHADER_FOOT;
}

function _construct_fragment_shader_source(sdfs){
  if(sdfs == undefined) sdfs = ""
  return FRAGMENT_SHADER_HEAD + sdfs + FRAGMENT_SHADER_BODY + FRAGMENT_SHADER_FOOT;
}
